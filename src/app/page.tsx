    ...
    <div className="flex flex-1 flex-col bg-purple-950">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 pt-6">
        <a
          ...
          className="flex min-h-[88px] items-center justify-between gap-4 rounded-2xl border border-emerald-500/10 bg-gradient-to-r from-emerald-950/20 to-purple-900/30 p-5 shadow-sm transition-all duration-300 hover:scale-[1.005] hover:border-emerald-500/30 hover:shadow-md"
        >
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-emerald-900/40 text-emerald-400">
            ...
            <div className="min-w-0">
              <p className="truncate font-semibold text-pink-50 sm:text-base text-sm">
                Profil eklemek isteyenler yazsın
              </p>
              <p className="text-xs text-pink-300 sm:text-sm">
