    ...
    return (
      <div className="flex flex-1 items-center justify-center bg-white dark:bg-zinc-950">
        <form
          ...
          className="w-full max-w-sm rounded-xl border border-zinc-100 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900"
        >
          <h1 className="mb-4 text-xl font-semibold text-zinc-700 dark:text-zinc-50">
            Admin Girişi
          </h1>
          <input
            type="password"
            ...
            className="mb-3 w-full rounded-lg border border-zinc-200 px-3 py-2 dark:border-zinc-700 dark:bg-zinc-800"
            required
          />
          {loginError && (
          ...
          <button
            type="submit"
            className="w-full rounded-lg bg-zinc-900 px-4 py-2 text-white hover:bg-zinc-700 dark:bg-zinc-50 dark:text-zinc-900"
          >
            Giriş Yap
          </button>
        </form>
  ...
  return (
    <div className="mx-auto w-full max-w-3xl flex-1 px-4 py-8">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-zinc-700 dark:text-zinc-50">
          Profil Yönetimi
        </h1>
        <button
      ...
      <form
        ...
        className="mb-8 grid grid-cols-1 gap-3 rounded-xl border border-zinc-100 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900 sm:grid-cols-4"
      >
        <input
          placeholder="İsim"
          value={firstName}
        ...
        <input
          ...
          required
        />
        <label className="col-span-full flex flex-col gap-1 text-sm text-zinc-500 dark:text-zinc-300 sm:col-span-2">
        ...
        <div className="col-span-full flex flex-col gap-2">
          <label className="flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-300">
            <input
              type="file"
              accept="image/*"
              multiple
          ...
          <textarea
            ...
            rows={2}
            className="rounded-lg border border-zinc-200 px-3 py-2 dark:border-zinc-700 dark:bg-zinc-800 text-sm"
          />
        </div>
        <div className="col-span-full flex justify-end gap-2">
          <button
            type="submit"
            className="rounded-lg bg-zinc-900 px-6 py-2 text-white hover:bg-zinc-700 dark:bg-zinc-50 dark:text-zinc-900"
          >
          ...
          {editingId && (
            <button
              ...
              className="rounded-lg border border-zinc-200 px-6 py-2 text-zinc-600 hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800"
            >
              Vazgeç
            </button>
          )}
      ...
      <label className="mb-3 flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-300">
        <input
          type="checkbox"
      ...
      <div className="space-y-2">
        {profiles
          ...
          >
            <div>
              <p className="font-medium text-zinc-700 dark:text-zinc-50">
                {profile.firstName} {profile.lastName} <span className="text-sm font-normal text-zinc-300 dark:text-zinc-500">(Yaş: {profile.age})</span>
              </p>
                ...
                <p
                  className={
                    isExpired(profile)
                      ...
                      : "text-xs text-zinc-300 dark:text-zinc-500"
                  }
                >
